...
class Simulation:
    ...
    def __init__(self, configFile):
        ...
        self.WINDOW_SIZE[0] = int(50*self.WIDTH+2)
        self.WINDOW_SIZE[1] = int(50*self.HEIGHT+2)
    ...
    def agent_move(self, number, next_state_pos):
        x_pos = self.agent_blocks[number].column
        y_pos = self.agent_blocks[number].row
        next_x_pos = next_state_pos[0]
        next_y_pos = next_state_pos[1]
        self.log["agents"][number].append((self.time_step, (x_pos, y_pos), next_x_pos, next_y_pos))

        self.agent_blocks[number].row = next_y_pos
        self.agent_blocks[number].column = next_x_pos

    def obstacle_move(self, number, next_state_pos):
...
#        self.log["agents"][number].append((self.time_step, (x_pos, y_pos), next_x_pos, next_y_pos))
        ...
        self.moving_obstacles[number].row = next_y_pos
        self.moving_obstacles[number].column = next_x_pos
